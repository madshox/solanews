  ...
  function () {
    ...
    _createClass(Ads, [{
      ...
      value: function onAdsManagerLoaded(event) {
        ...
        // so it can determine when to start the mid- and posts-roll

        this.manager = event.getAdsManager(this.player, settings); // Get the cue points for any mid-rolls by filtering out the pre- and posts-roll
       ...
       * the mid- and posts-roll launch at the correct time. And
